      ...
      return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full border border-red-100">
            ...
            <h2 className="text-2xl font-bold text-gray-900 text-center mb-4">Application Error</h2>
            <p className="text-gray-600 text-center mb-6">
              {errorMessage === 'Missing or insufficient permissions.' 
                ? 'You do not have permission to access this data. Please ensure you are logged in correctly.' 
                : errorMessage}
            </p>
            {errorDetails && (
            ...
            <button
              ...
              className="w-full bg-indigo-600 text-white font-semibold py-3 rounded-xl hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-200"
            >
              Reload Application
            </button>
          </div>
